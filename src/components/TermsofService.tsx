      ...
      <main className="max-w-4xl mx-auto px-6 py-12">
        <div className="bg-[#18181b] border border-[#2d2d32] rounded-2xl p-8 md:p-12">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">2.1 Eligibility</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">2.2 Account Registration</h3>
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">2.3 Officer Application Process</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          {/* Section 3 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">3. User Roles and Access</h2>
            
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">3.1 Role-Based Access</h3>
            <p className="text-gray-300 leading-relaxed mb-3">The Platform provides different levels of access based on user roles:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">3.2 Access Restrictions</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">4.1 Permitted Use</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">4.2 Prohibited Activities</h3>
            <p className="text-gray-300 leading-relaxed mb-3">You must not:</p>
            <ul className="list-disc list-inside text-gray-300 space-y-2 ml-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">5.1 Platform Ownership</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">5.2 User Content</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">5.3 Trademarks</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">7.1 Service Availability</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">7.2 Platform Modifications</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          {/* Section 8 */}
          <section className="mb-8">
            <h2 className="text-2xl font-semibold text-white mb-4">8. Third-Party Services and Links</h2>
            <p className="text-gray-300 leading-relaxed mb-4">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">9.1 "As Is" Provision</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">9.2 No Warranty</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">12.1 Termination by You</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              You may terminate your account at any time by contacting us or using the account deletion feature in the Platform.
            </p>

            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">12.2 Termination by Us</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">12.3 Effect of Termination</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">13.1 Governing Law</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">13.2 Dispute Resolution</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">14.1 Entire Agreement</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
            ...
            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">14.2 Severability</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              If any provision of these Terms is found to be unenforceable or invalid, that provision shall be limited or eliminated to the minimum extent necessary so that these Terms shall otherwise remain in full force and effect.
            </p>

            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">14.3 Waiver</h3>
            <p className="text-gray-300 leading-relaxed mb-4">
              No waiver of any term of these Terms shall be deemed a further or continuing waiver of such term or any other term.
            </p>

            <h3 className="text-xl font-semibold text-orange-500 mb-3 mt-6">14.4 Assignment</h3>
            <p className="text-gray-300 leading-relaxed">
          ...
          <section className="mb-8">
            ...
            <div className="bg-[#0b0c0e] border border-[#2d2d32] rounded-lg p-6">
              <p className="text-gray-300 mb-2"><strong>Email:</strong> legal@digital.gov.pg</p>
